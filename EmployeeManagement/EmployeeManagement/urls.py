...
urlpatterns = [
    ...
    path('viewemp/',views.viewEmployee),
    path('empregister/',views.employeeRegister_form,name='register'),
    path('viewdisplay',views.view_datadisplay,name='vieweDisplay'),
    path('delete/',views.dataDelete),
    path('change',views.DataChange),
